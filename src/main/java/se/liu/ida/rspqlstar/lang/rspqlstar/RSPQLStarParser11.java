...
public class RSPQLStarParser11 extends RSPQLParserBase implements RSPQLStarParser11Constants {
    ...
    final public Element WindowPattern() throws ParseException {
        Element el;
        String n;
        jj_consume_token(WINDOW);
        n = iri();
            ...
            case CARAT: {
                ...
                switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
                    ...
                    case PNAME_LN: {
                        ...
                        n = createNode(str);
                        {
                            if ("" != null) return new P_ReverseLink(n);
                        }
                        break;
                    }
                    case KW_A: {
    ...
    final public Node VarOrTermOrEmbTP() throws ParseException {
        Node n = null;
        switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
            case VAR1:
            case VAR2: {
    ...
    final public Node EmbTP() throws ParseException {
        Node s = null;
        Node p = null;
        Node o = null;
    ...
    final public Node VarOrBlankNodeOrIriOrEmbTP() throws ParseException {
        Node n = null;
        String iri;
        switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
            case VAR1:
